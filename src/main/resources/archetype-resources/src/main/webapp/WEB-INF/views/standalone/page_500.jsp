        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="col-middle">
            <div class="text-center text-center">
              ...
              <p><spring:message code="common.failure.uncaughtexception.message" /> <a href="${symbol_dollar}{pageContext.request.contextPath}/welcome"><spring:message code="common.home" /></a>
              </p>
            </div>
          </div>
        </div>
